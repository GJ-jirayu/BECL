...
//		String paramMonth = "10";
		String query="SELECT DP.PLAZA_NAME_TH, SUM(FPT.NO_OF_POS_TRANS), DD.CALENDAR_MONTH_NO FROM FACT_POS_TRANS FPT "
				...
				+"WHERE DA.ACTIVITY_ID=1 AND DD.CALENDAR_YEAR = "+paramYear+" AND DD.CALENDAR_MONTH_NO= "+paramMonth+" "
