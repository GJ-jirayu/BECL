...
//                },
		      ...
		      axes: {
		        ...
		        yaxis: {
                   tickRenderer: $.jqplot.CanvasAxisTickRenderer,
		        	...
		        	max:maxY,
		        	label: option['labelY'],
		        	marginTop: option['yaxis-marginTop']
		        }
		      },
		      ...
		      legend:{ 
	                ...
	                marginTop : option['legend-marginTop'],
	                rendererOptions: {
		 ...
		 $('#Chart_Tap2-3').bind('jqplotDataMouseOver', function (ev, seriesIndex, pointIndex, data) {
			 $(".jqplot-highlighter-tooltip").css({"backgroundColor":plot2.series[seriesIndex].seriesColors[seriesIndex]});
		 });
	};
